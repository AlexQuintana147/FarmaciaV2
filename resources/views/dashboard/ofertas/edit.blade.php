...
<div class="container py-4">
    <div class="bg-gradient-primary-to-secondary p-3 rounded-3 mb-4 shadow-sm" style="background: linear-gradient(135deg, #ff6b6b, #ff8e53);">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="text-white mb-0"><i class="fas fa-edit me-2"></i>Editar Oferta</h1>
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg @error('titulo') is-invalid @enderror" id="titulo" name="titulo" value="{{ old('titulo', $oferta->titulo) }}" placeholder="Nombre de la oferta o promoción" required>
                            @error('titulo')
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4 p-3 border rounded bg-light">
                                    <div class="image-preview text-center d-flex align-items-center justify-content-center" style="height: 200px;">
                                        <div id="preview-placeholder" style="{{ $oferta->imagen ? 'display: none;' : '' }}">
