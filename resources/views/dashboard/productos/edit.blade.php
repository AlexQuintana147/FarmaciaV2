        ...
        <div class="card-body p-4">
            <form action="{{ route('productos.update', $producto) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('titulo') is-invalid @enderror" id="titulo" name="titulo" value="{{ old('titulo', $producto->titulo) }}" required>
                            @error('titulo')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="5" required>{{ old('descripcion', $producto->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mt-3 text-center">
                            <div class="image-preview border rounded p-2 d-flex align-items-center justify-content-center" style="height: 200px; background-color: #f8f9fa;">
                                @if($producto->imagen)
                                    <img id="preview-image" src="{{ asset($producto->imagen) }}" alt="{{ $producto->titulo }}" style="max-height: 180px; max-width: 100%;">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <a href="{{ route('dashboard.productos') }}" class="btn btn-outline-secondary me-2">Cancelar</a>
